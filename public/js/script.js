    ...
    $('input').blur(function () {
        ...
        if ($(this).hasClass('name')) {
            if ($(this).val().length === 0) {
                ...
                $(this).siblings('span.error').text('Escriba al menos 6 caracteres').fadeIn().parent('.form-group').addClass('hasError');
                usernameError = true;
            } else {
        ...
        if ($(this).hasClass('email')) {
            if ($(this).val().length == '') {
                $(this).siblings('span.error').text('Dirección de correo electrónico').fadeIn().parent('.form-group').addClass('hasError');
                emailError = true;
            } else {
                $(this).siblings('.error').text('').fadeOut().parent('.form-group').removeClass('hasError');
                emailError = false;
